...
# SplitB（大B小S 前向模板）host 侧：tiling 填充 + launch（kernel 模板在 autogen TU 内）
src_ascend910_v2 += glob.glob(os.path.join(this_dir, "csrc/ascend910/flash_attn_npu", "splitb_host.cpp"), recursive=True)
