...
test_cases_varlen = [
    (torch.bfloat16, 3, 1, 1, 512, 1024, 128, True, 0.0, False),
    (torch.float16, 5, 5, 1, 512, 512, 128, True, 0.0, False),
    (torch.float16, 5, 5, 1, 777, 888, 192, False, 0.0, False),
    (torch.float16, 5, 5, 1, 1777, 1888, 256, True, 0.0, False),
    (torch.bfloat16, 3, 1, 1, 7777, 8192, 64, True, 0.0, False),
    (torch.bfloat16, 5, 5, 1, 711, 8192, 111, True, 0.0, False),
    (torch.bfloat16, 3, 1, 1, 512, 1024, 128, True, 30.0, False),
    (torch.float16, 5, 5, 1, 512, 512, 128, True, 30.0, False),
    (torch.float16, 5, 5, 1, 777, 888, 192, False, 30.0, False),
    (torch.float16, 5, 5, 1, 1777, 1888, 256, True, 30.0, False),
    (torch.bfloat16, 3, 1, 1, 7777, 8192, 64, True, 30.0, False),
    (torch.bfloat16, 5, 5, 1, 711, 8192, 111, True, 30.0, False),
...
test_cases_varlen_swa = [
    (torch.bfloat16, 3, 1, 1, 512, 1024, 128, True, 512, 0, 0.0, False),
    (torch.bfloat16, 3, 1, 1, 512, 1024, 128, False, 0, 256, 0.0, False),
    (torch.float16, 3, 2, 2, 512, 512, 128, False, 64, 128, 0.0, False),
    (torch.bfloat16, 3, 1, 1, 512, 1024, 128, True, 512, 0, 30.0, False),
    (torch.bfloat16, 3, 1, 1, 512, 1024, 128, False, 0, 256, 30.0, False),
    (torch.float16, 3, 2, 2, 512, 512, 128, False, 64, 128, 30.0, False),
    ...
    (torch.float16, 3, 4, 2, 512, 512, 128, False, 64, 128, 0.0, True),
