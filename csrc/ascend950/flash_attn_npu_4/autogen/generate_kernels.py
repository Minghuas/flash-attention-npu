...
# Splits the v4 (950) forward FAInfer dispatch into four per-(dtype, layout)
...
def fai_kernel(dtype_key: str, layout: tuple) -> Kernel:
    ...
    content = (
        PRELUDE
        + f"// v4 (950) forward FAInfer dispatch, {dtype_key} x {display} variant.\n"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        description="Generate the v4 (950) forward dispatch template instantiations "
